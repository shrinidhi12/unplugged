...
_Source: `src/components/SuggestionBoxButton.tsx`, `src/app/suggest/page.tsx`, `src/components/SuggestionForm.tsx`_

- **Top-right link (home, create, invite, reply, and host pages):** Suggestion box
- **Page title:** Suggestion box
- **Page subtitle:** Ideas, bugs, hot takes, love notes. It all comes straight to me, and I read every one.
...
- **Heading:** Got it, thanks{, name}.
- **Body:** Your note is on its way to me. _(+ " If it needs a reply, I'll write back." when they left an email)_
- **Link:** Send another

**Validation messages** _(source: `src/app/actions.ts`)_:

- Write something first.
- That's too long. Keep it under 5,000 characters.
- That email doesn't look right. Fix it, or leave it blank.
- The suggestion box is closed for a moment. Please try again later.

**Email to you:**

- **Subject:** Suggestion box: note from {name, or "Anonymous"}
- **Heading:** Note from {name, or "Anonymous"}
- **Body:** {their note}
